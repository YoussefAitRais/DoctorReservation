...
<body  class="bg-cover bg-center h-screen flex items-center justify-center bg-opacity-75" style="background-image: url('./image/doctor.jpg')">
<div class="min-h-screen flex flex-col items-center justify-center">
    <h1 class="text-4xl font-bold text-blue-600 mb-6">Bienvenue sur DoctorRV</h1>
    <p class="text-lg text-black font-bold mb-8">Système de réservation de rendez-vous médicaux</p>
