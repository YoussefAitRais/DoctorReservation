...
<body class="bg-cover bg-center h-screen flex flex-col justify-center items-center bg-opacity-75" style="background-image: url('./image/doctor.jpg')">

<!-- Navbar -->
<nav class="bg-blue-600 p-4 text-white shadow-md w-full fixed top-0">
